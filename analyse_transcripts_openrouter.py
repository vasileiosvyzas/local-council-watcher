...
3. Να δώσεις μια συνοπτική περιγραφή της απόφασης που πάρθηκε για κάθε θέμα
4. Να κατηγοριοποιήσεις ανα άτομο τις δουλειές που ανατέθηκαν, αν υπάρχουν
...
def call_openrouter(
    ...
    # print("Raw content from OpenRouter:")
